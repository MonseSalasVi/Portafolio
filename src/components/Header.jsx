        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between py-4 px-6">
            ...
            {menuOpen && (
                <nav className="md:hidden flex flex-col gap-2 px-6 pb-6 bg-background text-foreground transition-colors duration-300">
                    <a href="#about" className="transition px-3 py-2 rounded hover:text-primary hover:bg-primary/20">
                        {t.nav.about}
                    </a>
                    <a href="#projects" className="transition px-3 py-2 rounded hover:text-primary hover:bg-primary/20">
                        {t.nav.projects}
                    </a>
                    <a href="#skills" className="transition px-3 py-2 rounded hover:text-primary hover:bg-primary/20">
                        {t.nav.skills}
                    </a>
                    <a href="#contact" className="transition px-3 py-2 rounded hover:text-primary hover:bg-primary/20">
                        {t.nav.contact}
                    </a>
                </nav>
            )}
